...
The protocol bypasses traditional industry middlemen to establish a direct, trustless Peer-to-Peer (P2P) value transfer network between artists and their communities.
...
graph TD
    ...
    subgraph Infrastructure [Blockchain & Ledger]
