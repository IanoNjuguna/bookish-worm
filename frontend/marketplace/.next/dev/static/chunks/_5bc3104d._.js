...
function CardanoProvider({ children }) {
    ...
    const initializeLucid = async (wallet, seedPhrase)=>{
        ...
        try {
            if (wallet === "utxos" && !seedPhrase && ("TURBOPACK compile-time value", "object") !== "undefined") {
            ...
            const projectId = (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BLOCKFROST_PROJECT_ID"] || "").trim();
            if (!projectId) {
                throw new Error(`Missing Blockfrost key for ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARDANO_NETWORK"]}. Set ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARDANO_NETWORK"] === "Mainnet" ? "NEXT_PUBLIC_BLOCKFROST_PROJECT_ID_MAINNET" : "NEXT_PUBLIC_BLOCKFROST_PROJECT_ID_PREPROD"} in .env.local and restart Next.js.`);
            }
            // Preflight Blockfrost credentials to avoid opaque Lucid init errors
            const healthRes = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BLOCKFROST_URL"]}/health`, {
                headers: {
                    project_id: projectId
                }
            });
            if (!healthRes.ok) {
                throw new Error(`Blockfrost auth failed (${healthRes.status}). Verify your ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARDANO_NETWORK"]} project ID and network setting.`);
            }
            // Initialize provider
            const blockfrostProvider = new Blockfrost(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BLOCKFROST_URL"], projectId);
            // Initialize Lucid
            let lucidInstance;
            try {
                lucidInstance = await Lucid(blockfrostProvider, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARDANO_NETWORK"]);
            } catch (lucidInitError) {
                ...
                if (message.includes("Cannot convert undefined to a BigInt") || message.includes("BigInt")) {
                    throw new Error(`Failed to initialize Cardano provider for ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARDANO_NETWORK"]}. Check your Blockfrost credentials and ensure network access is enabled.`);
                }
                ...
                try {
                    ...
                    setWalletApi({
                        signData: async (address, payload)=>{
                            const selectedWallet = typeof lucidInstance.wallet === "function" ? lucidInstance.wallet() : lucidInstance.wallet;
    ...
    const connect = async (wallet)=>{
        if (wallet === "utxos" && ("TURBOPACK compile-time value", "object") !== "undefined") {
...
function addNotification(message, level = 'default', options = {}) {
    if (!isBrowser()) //TURBOPACK unreachable
    ;
...
function patchToastNotifications() {
    ...
    const originalSuccess = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success.bind(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"]);
    const originalError = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error.bind(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"]);
    const originalInfo = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info.bind(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"]);
    const originalWarning = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].warning.bind(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"]);
    const originalDefault = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].bind(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"]);
    const getHrefFromArgs = (args)=>{
        const first = args[0];
        if (!first || typeof first !== 'object') return undefined;
        const candidate = first.href;
        return typeof candidate === 'string' ? candidate : undefined;
    };
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success = (message, ...args)=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addNotification"])(toMessage(message), 'success', {
            href: getHrefFromArgs(args)
        });
        return originalSuccess(message, ...args);
    };
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error = (message, ...args)=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addNotification"])(toMessage(message), 'error', {
            href: getHrefFromArgs(args)
        });
        return originalError(message, ...args);
    };
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info = (message, ...args)=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addNotification"])(toMessage(message), 'info', {
            href: getHrefFromArgs(args)
        });
        return originalInfo(message, ...args);
    };
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].warning = (message, ...args)=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addNotification"])(toMessage(message), 'warning', {
            href: getHrefFromArgs(args)
        });
        return originalWarning(message, ...args);
    };
    const wrappedDefault = (message, ...args)=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addNotification"])(toMessage(message), 'default', {
            href: getHrefFromArgs(args)
        });
        return originalDefault(message, ...args);
    };
    Object.assign(wrappedDefault, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"]);
}
const Toaster = ({ ...props })=>{
    _s();
...
//# sourceMappingURL=_5bc3104d._.js.map