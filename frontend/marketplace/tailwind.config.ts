...
const config: Config = {
  ...
  theme: {
    extend: {
      fontFamily: {
        sans: 'var(--font-chivo), "Chivo", Arial, sans-serif',
        display: 'var(--font-space-mono), "Space Mono", ui-monospace, SFMono-Regular, "SF Mono", Menlo, Consolas, "Liberation Mono", "Courier New", monospace',
