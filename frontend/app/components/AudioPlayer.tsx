...
export default function AudioPlayer({ playerState }: AudioPlayerProps) {
  ...
  return (
    <div className="fixed md:relative bottom-0 left-0 right-0 z-50 w-full h-auto md:h-[90px] bg-[rgba(250,249,246,0.95)] dark:bg-[rgba(13,13,18,0.95)] backdrop-blur-md md:bg-transparent md:backdrop-blur-none border-t border-midnight/[0.08] dark:border-white/[0.08] md:border-t-0 pb-[env(safe-area-inset-bottom)] flex-shrink-0">
