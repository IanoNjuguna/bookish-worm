        ...
        <div className="h-full px-4 lg:px-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button 
              ...
              className="hidden lg:flex items-center justify-center w-9 h-9 border border-midnight/10 dark:border-white/10 rounded-none bg-midnight/5 dark:bg-white/5 hover:border-cyber-pink/50 transition-colors text-midnight/70 dark:text-white/70 hover:text-midnight dark:hover:text-white group relative shrink-0"
