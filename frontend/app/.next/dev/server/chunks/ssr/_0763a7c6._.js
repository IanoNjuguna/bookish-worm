...
function SendFunds() {
    ...
    const handleSend = async ()=>{
        ...
        if (lovelace + 1500000n > currentBalance) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Insufficient balance to cover the transaction amount and network fees.");
            return;
        }
        setIsSending(true);
        try {
